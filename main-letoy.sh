...
if [ ! -z "$1" ] && [ "$1" == 'initial' ];then
    ...
    git clone https://github.com/ZyCromerZ/AnyKernel3 -b master-lancelot $AnykernelDir --depth=1
...
CompileKernel(){
    ...
    git fetch origin 285dc675b36c --depth=2
    git cherry-pick 285dc675b36c
